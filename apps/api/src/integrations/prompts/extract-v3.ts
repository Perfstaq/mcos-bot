 ...
 *   live (gpt-5.6-terra, 26 Aug 2026): recall 1.00 · noise FPs 0 · type 0.96 · evidence 0.86 — FAIL
 *     (evidence floor is 0.9: all four multi-segment answer-key entries were
 *     under-cited — the model cites the primary turn but not the adjacent turn
 *     that completes the claim. Fixed in v4 with a citation-completeness rule.)
 *
